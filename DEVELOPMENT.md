...
```bash
git clone https://github.com/zephinax/personal-website.git personal-website
cd personal-website
```
...
If you're working on a different React project and want to reuse the custom components from this repository, visit [zephinax.com/components](https://zephinax.com/components) for installation instructions and component documentation.
