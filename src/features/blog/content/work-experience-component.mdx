...
image: /images/blog/work-experience-component.webp?t=1750149861
category: components
...
<ComponentPreview
  ...
  openInV0Url="https://zephinax.com/r/work-experience-block-01.json"
  notProse={false}
  codeCollapsible
/>
...
```bash
npx shadcn add @zephinax/work-experience
```
