...
<ComponentPreview
  ...
  openInV0Url="https://zephinax.com/r/theme-switcher.json"
/>
...
```bash
npx shadcn add @zephinax/theme-switcher
```
...
<ComponentSource
  name="theme-switcher"
  title="components/zephinax/theme-switcher.tsx"
  showLineNumbers
/>
...
```tsx
import { ThemeSwitcher } from "@/components/zephinax/theme-switcher";
```
