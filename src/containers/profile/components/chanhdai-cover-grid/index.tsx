...
export const Plus = ({ className }: { className?: string }) => {
  return (
    <div className={cn("h-6 w-6", className)}>
      <span className="absolute top-0 left-0 box-content flex h-[11.5px] w-6 border-b border-zinc-300 dark:border-zinc-700" />
...
export const ChanhDaiCoverGrid = () => {
  return (
    <div className="aspect-h-1 aspect-w-2 relative flex w-full border border-zinc-100 bg-white select-none dark:border-zinc-900 dark:bg-zinc-950">
      <div className="absolute inset-0 z-10 *:absolute">
        <Plus className="-top-[12.5px] -left-[12.5px]" />
        <Plus className="-top-[12.5px] -right-[12.5px]" />
        <Plus className="-right-[12.5px] -bottom-[12.5px]" />
        <Plus className="-bottom-[12.5px] -left-[12.5px]" />
      </div>

      <div className="top-1/2 box-content h-16 w-full -translate-y-1/2 border-y border-zinc-100 sm:h-20 dark:border-zinc-900" />
