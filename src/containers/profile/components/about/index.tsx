  ...
  return (
    <>
      ...
      <section className="mb-4 space-y-2 rounded-xl border border-slate-200 bg-white p-4 dark:border-slate-700 dark:bg-slate-800">
        <p>
          Hello, I am Chánh Đại, a Senior Frontend Developer at{" "}
        ...
        <p>
          ...
          <ExternalLink href="https://zadark.com">ZaDark</ExternalLink> - a
          utility enabling Dark Mode for Zalo on PC and Web. Available on
          various platforms, it has over 70,000 downloads on{" "}
          <ExternalLink href="https://sourceforge.net/projects/zadark">
            SourceForge
          </ExternalLink>{" "}
          and over 7,000 installs on the{" "}
