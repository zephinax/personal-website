  ...
  return (
    <div className="overflow-hidden rounded-xl">
      <Image
        ...
        placeholder="blur"
        // placeholder={`data:image/svg+xml,%3Csvg width='${WIDTH}' height='${HEIGHT}' viewBox='0 0 ${WIDTH} ${HEIGHT}' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Crect width='${WIDTH}' height='${HEIGHT}' fill='#3773f6'/%3E%3C/svg%3E%0A`}
